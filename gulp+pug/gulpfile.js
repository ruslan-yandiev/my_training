// ! npm install --save-dev gulp gulp-sass browser-sync gulp-file-include del gulp-autoprefixer gulp-group-css-media-queries gulp-clean-css gulp-rename gulp-uglify-es gulp-imagemin gulp-webp gulp-webp-html gulp-webpcss gulp-svg-sprite gulp-pug
...
const path = {
    ...
    src: {
        ...
        pug: [`${source_folder}/*.pug`, `!${source_folder}/_header.pug`],
