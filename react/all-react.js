...
useEffect(функция callback, Массив зависимостей) - если массив зависимостей будет пустым то хук отработает один раз в момент монтирования компонента. Таким образом мы можем отследить эту стадию монтирования и выполнить нужные для нас действия (к примеру отгрузить список постов).
*/